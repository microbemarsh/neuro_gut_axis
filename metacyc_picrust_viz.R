...
pan_sham = df %>%
  select("pathway","Villapol_274_B", "Villapol_275_B", "Villapol_276_B", "Villapol_277_B",  
...
daa_results_df <- pathway_daa(pan_sham, 
                              metadata = pan_sham_meta, 
                              group = "Timepoint", 
                              daa_method = "LinDA")
...
veh_sham = df %>%
  select("pathway","Villapol_284_B", "Villapol_285_B", "Villapol_286_B", "Villapol_287_B",
...
daa_results_df <- pathway_daa(veh_sham, 
                              metadata = veh_sham_meta, 
                              group = "Timepoint", 
                              daa_method = "LinDA")
...
veh_cci = df %>%
  select("pathway","Villapol_254_B", "Villapol_255_B", "Villapol_256_B", "Villapol_257_B", "Villapol_258_B",  
...
daa_results_df <- pathway_daa(veh_cci, 
                              metadata = veh_cci_meta, 
                              group = "Timepoint", 
                              daa_method = "LinDA")
